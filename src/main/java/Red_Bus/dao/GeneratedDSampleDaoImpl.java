...
/**
 * The DSample domain-object specific finders and methods go in this POJO.
 * 
 * Generated on 2013-05-15T16:15:07.327+0700.
 * @author mardao DAO generator (net.sf.mardao.plugin.ProcessDomainMojo)
 */
public class GeneratedDSampleDaoImpl extends TypeDaoImpl<DSample, java.lang.Long> 
	implements GeneratedDSampleDao {
    ...
    /** Default constructor */
   public GeneratedDSampleDaoImpl() {
      super(DSample.class, java.lang.Long.class);
   }
   ...
   protected DaoImpl getManyToOneDao(String columnName) {
    ...
    @Override
    protected Object getDomainProperty(DSample domain, String name) {
        Object value;
        // simple key?
    ...
    @Override
    protected void setDomainProperty(final DSample domain, final String name, final Object value) {
        // simple key?
        if (COLUMN_NAME_ID.equals(name)) {
    ...
    @Override
    protected void setDomainStringProperty(final DSample domain, final String name, final Map<String, String> properties) {
   ...
   // ------ END DaoImpl overrides -----------------------------
        ...
        // DSample has no parent

        /**
         * @return the simple key for specified DSample domain object
         */
        public Long getSimpleKey(DSample domain) {
            if (null == domain) {
                return null;
            }
            return domain.getId();
         ...
         * @return the simple key for specified DSample domain object
         */
        public void setSimpleKey(DSample domain, Long id) {
            domain.setId(id);
        }
        ...
        public String getCreatedBy(DSample domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setCreatedBy(DSample domain, String creator) {
        ...
        public String getUpdatedBy(DSample domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setUpdatedBy(DSample domain, String updator) {
        ...
        public Date getCreatedDate(DSample domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setCreatedDate(DSample domain, Date date) {
        ...
        public Date getUpdatedDate(DSample domain) {
            if (null == domain) {
                return null;
            }
        ...
        public void _setUpdatedDate(DSample domain, Date date) {
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DSample> queryByCreatedBy(java.lang.String createdBy) {
	 ...
	 * @return an Iterable of keys to the DSamples with the specified attribute
	 */
	 ...
	 */
	public final CursorPage<DSample, java.lang.Long> queryPageByCreatedBy(java.lang.String createdBy,
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DSample> queryByCreatedDate(java.util.Date createdDate) {
	 ...
	 */
	public final CursorPage<DSample, java.lang.Long> queryPageByCreatedDate(java.util.Date createdDate,
            int pageSize, String cursorString) {
            final Filter filter = createEqualsFilter(COLUMN_NAME_CREATEDDATE, createdDate);
            return queryPage(false, pageSize, null, null, null, false, null, false, cursorString, filter);
        }
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DSample> queryByPhoneNumber(java.lang.String phoneNumber) {
	 ...
	 */
	public final CursorPage<DSample, java.lang.Long> queryPageByPhoneNumber(java.lang.String phoneNumber,
            int pageSize, String cursorString) {
            final Filter filter = createEqualsFilter(COLUMN_NAME_PHONENUMBER, phoneNumber);
            return queryPage(false, pageSize, null, null, null, false, null, false, cursorString, filter);
        }
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DSample> queryByUpdatedBy(java.lang.String updatedBy) {
	 ...
	 */
	public final CursorPage<DSample, java.lang.Long> queryPageByUpdatedBy(java.lang.String updatedBy,
            int pageSize, String cursorString) {
            final Filter filter = createEqualsFilter(COLUMN_NAME_UPDATEDBY, updatedBy);
            return queryPage(false, pageSize, null, null, null, false, null, false, cursorString, filter);
        }
	...
	/**
         * {@inheritDoc}
	 */
	public final Iterable<DSample> queryByUpdatedDate(java.util.Date updatedDate) {
	 ...
	 */
	public final CursorPage<DSample, java.lang.Long> queryPageByUpdatedDate(java.util.Date updatedDate,
            int pageSize, String cursorString) {
            final Filter filter = createEqualsFilter(COLUMN_NAME_UPDATEDDATE, updatedDate);
            return queryPage(false, pageSize, null, null, null, false, null, false, cursorString, filter);
        }
	 ...
	 */
	public DSample persist(		java.lang.Long id, 
